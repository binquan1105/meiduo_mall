...
class GoodsCategory(QQuserDate):
    """商品类别"""
...
class GoodsChannelGroup(QQuserDate):
    """商品频道组"""
...
class SPUSpecification(QQuserDate):
    """商品SPU规格"""
...
class SpecificationOption(QQuserDate):
    """规格选项"""
...
class SKUSpecification(QQuserDate):
    """SKU具体规格"""
...
class GoodsVisitCount(QQuserDate):
    """统计分类商品访问量模型类"""
