...
class APIClient(object):
    ...
    def get_authorize_url(self):
        return "https://api.weibo.com/oauth2/authorize?response_type=code&client_id=%s&redirect_uri=%s&forcelogin=%s" % (
        self.client_id, self.redirect_uri,self.forcelogin)
